      ...
      <section className="relative h-[400px] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            About <span className="text-brand-orange">LogiCorp</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                Founded in 1998, LogiCorp began with a simple mission: to provide reliable, transparent, and efficient logistics solutions. Over the decades, we have grown from a small regional carrier into a global powerhouse in freight forwarding and supply chain management.
              </p>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
